...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/01 12:24:39 by kyungsle          #+#    #+#             */
/*   Updated: 2022/02/01 12:58:19 by kyungsle         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

int	return_new_line(t_fd *target, char *nptr, char **res)
{
	char	*tmp;
...
int	readfd(t_fd *target, char *buf, char **res)
{
	char		*nptr;
	char		*tmp;
	ssize_t		cc;
